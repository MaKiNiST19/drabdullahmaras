                            ...
                            <form className={styles.form}>
                                ...
                                <div className={styles.formGroup}>
                                    ...
                                    <select id="subject" name="subject">
                                        ...
                                        <option value="cocuk-ergen">Çocuk ve Ergen Psikiyatrisi</option>
                        ...
                        <aside className={styles.sidebar}>
                            <div className={styles.infoCard}>
                                ...
                                <div className={styles.infoItem}>
                                    ...
                                    <div><strong>Adres</strong><span>Altay Mahallesi, Eryaman<br />Etimesgut / Ankara</span></div>
                                </div>
                                <div className={styles.infoItem}>
                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="10" /><polyline points="12 6 12 12 16 14" /></svg>
                                    <div><strong>Çalışma Saatleri</strong><span>Hafta içi: 09:00 – 17:00</span></div>
                                </div>
                                <div className={styles.infoItem}>
